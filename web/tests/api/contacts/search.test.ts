...
describe("GET /api/contacts/search", () => {
  ...
  it("returns 400 when query parameter is missing", async () => {
    const request = createRequest("/api/contacts/search")
  ...
  it("returns 400 when query parameter is empty", async () => {
    const request = createRequest("/api/contacts/search?q=")
    const response = await GET(request)
  ...
  it("returns 400 when query parameter is whitespace only", async () => {
    const request = createRequest("/api/contacts/search?q=%20%20%20")
    const response = await GET(request)
  ...
  it("returns contacts when query is provided", async () => {
    const request = createRequest("/api/contacts/search?q=john")
    const response = await GET(request)
  ...
  it("respects limit parameter", async () => {
    const request = createRequest("/api/contacts/search?q=test&limit=2")
    const response = await GET(request)
  ...
  it("caps limit at 100", async () => {
    const request = createRequest("/api/contacts/search?q=test&limit=500")
    const response = await GET(request)
  ...
  it("includes query in response", async () => {
    const request = createRequest("/api/contacts/search?q=searchterm")
    const response = await GET(request)
  ...
  it("handles default limit of 50", async () => {
    const request = createRequest("/api/contacts/search?q=test")
    const response = await GET(request)
